 ...
 <body>
   ...
   <div id="wrapper">
     ...
     <div id="page-wrapper">
       <div class="row">
         <div class="col-lg-12">
           <h1 class="page-header"> Tabel Data Ajuan</h1>
         </div>
       </div>
           ...
           <div class="modal-content">
             ...
             <div class="modal-body">
               <form action="?m=ajuan&s=simpan" method="POST" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                   <label for="exampleInputPeriod">Periode (Tahun-Bulan)</label>
                   <input type="date" class="form-control" id="exampleInputPeriod" name="periode" aria-describedby="emailHelp">
                   <small id="emailHelp" class="form-text text-muted">Pilih Periode (Tahun-Bulan)</small>
                 </div>
         ...
         <div class="row">
           <div class="col-lg-12">
             <p class="text-muted" style="font-size: 16px;">Copyright &copy; <script>
               ...
               </script> Aplikasi Pendataan Barang Gudang</p>
           </div>
         </div>
       </div>
     </div>
